...
struct ScrapData{
    ...
    let scrapG = ScrapSample(scrapImgView: #imageLiteral(resourceName: "dabi"), scrapTitle: "didkdkkdkdk", scrapCategory: "TMI", scrapDate: "1889.22.23")
    let scrapH = ScrapSample(scrapImgView: #imageLiteral(resourceName: "dabi"), scrapTitle: "didkdkkdkdk", scrapCategory: "TMI", scrapDate: "1889.22.23")
    let scrapI = ScrapSample(scrapImgView: #imageLiteral(resourceName: "dabi"), scrapTitle: "didkdkkdkdk", scrapCategory: "TMI", scrapDate: "1889.22.23")
    init() {
        scraps.append(contentsOf: [scrapA,scrapB,scrapC,scrapD,scrapE,scrapF,scrapH,scrapI])
    }
}
