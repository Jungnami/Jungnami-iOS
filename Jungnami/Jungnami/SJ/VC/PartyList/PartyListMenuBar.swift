...
class PartyListMenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var homeController: PartyListPageMenuVC?
    let cellId = "cellId"
    let imageNames = ["정당", "지역"]
