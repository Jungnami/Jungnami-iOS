...
struct SampleLegislatorData {
    ...
    init() {
        ...
        let c = SampleLegislator(profile: #imageLiteral(resourceName: "dabi"), name: "이지현", likeCount: 12, dislikeCount: 1, region: "대전 대덕구 송촌동", party: .red, likeRank: 6, dislikeRank: 2, voteCount: 200000, rate: 1.0)
        ...
        let e = SampleLegislator(profile: #imageLiteral(resourceName: "jihee"), name: "강지희", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .orange, likeRank: 2, dislikeRank: 4, voteCount: 200000, rate: 0.2)
        let f = SampleLegislator(profile: #imageLiteral(resourceName: "seunghu"), name: "정승후", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .yellow, likeRank: 1, dislikeRank: 4, voteCount: 200000, rate: 0.6)
         let g = SampleLegislator(profile: #imageLiteral(resourceName: "sungchan"), name: "강성찬", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .mint, likeRank: 3, dislikeRank: 4, voteCount: 200000, rate: 0.75)
         let h = SampleLegislator(profile: #imageLiteral(resourceName: "yunhwan"), name: "남윤환", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .blue, likeRank: 12, dislikeRank: 1, voteCount: 200000, rate: 0.84)
         let i = SampleLegislator(profile: #imageLiteral(resourceName: "sunyoung"), name: "이선영", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .blue, likeRank: 12, dislikeRank: 3, voteCount: 200000, rate: 0.1)
         let j = SampleLegislator(profile: #imageLiteral(resourceName: "hyungyun"), name: "최형윤", likeCount: 12, dislikeCount: 1, region: "서울 성북구 안암동", party: .orange, likeRank: 2, dislikeRank: 2, voteCount: 200000, rate: 0.8)
